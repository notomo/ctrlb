...
router.add("tab/moveLeft", tab, tab.moveLeft, [v.optionalNumber()], ["id"]);
router.add("tab/moveRight", tab, tab.moveRight, [v.optionalNumber()], ["id"]);
router.add("tab/moveFirst", tab, tab.moveFirst, [v.optionalNumber()], ["id"]);
router.add("tab/moveLast", tab, tab.moveLast, [v.optionalNumber()], ["id"]);
router.add("tab/close", tab, tab.close, [v.optionalNumber()], ["id"]);
...
router.add("tab/duplicate", tab, tab.duplicate, [v.optionalNumber()], ["id"]);
router.add("tab/reload", tab, tab.reload, [v.optionalNumber()], ["id"]);
